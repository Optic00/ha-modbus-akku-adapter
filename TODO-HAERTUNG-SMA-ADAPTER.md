...
- [x] Gerätetest analog Huawei-Pflichttests: BESTANDEN 12.7.2026 - alle vier Sperr-Richtungen (Pause/nur Laden/nur Entladen bei Überschuss UND Last) über >= 10-min-Fenster bewiesen, dazu Handoffs, Wächter-Proben, Queue/Status-Gate/Neustart. Protokoll: `docs/geraetetests-haertung-2026-07.md`.
